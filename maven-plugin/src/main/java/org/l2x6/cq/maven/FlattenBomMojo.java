...
public class FlattenBomMojo extends AbstractMojo {
    ...
    /**
     * Add exclusions to the specified artifacts coming from third party imported BOMs in the flattened BOM,
     * or perform some version transformations. While {@link #bomEntryTransformations} are supposed to be maintained
     * manually, {@link #autogeneratedBomEntryTransformations} are generated by this mojo with
     * {@code -Dcq.flatten-bom.format}
     * <p>
     * An example:
     *
     * <pre>
    ...
    /**
     * {@link BomEntryTransformation}s generated by this mojo based on {@link #bannedDependencyResources}.
     * Same syntax as {@link #bomEntryTransformations}.
     * It is practical to keeps these separate from {@link #bomEntryTransformations} which are supposed to be maintained
     * manually.
     *
     * @since 3.6.0
     */
    @Parameter
    List<FlattenBomTask.BomEntryTransformation> autogeneratedBomEntryTransformations;
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        if (autogeneratedBomEntryTransformations != null) {
            bomEntryTransformations.addAll(autogeneratedBomEntryTransformations);
        }
